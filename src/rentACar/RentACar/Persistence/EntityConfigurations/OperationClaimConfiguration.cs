...
public class OperationClaimConfiguration : IEntityTypeConfiguration<OperationClaim>
{
    public void Configure(EntityTypeBuilder<OperationClaim> builder)
    {
        ...
        builder.Property(oc => oc.UpdatedDate).HasColumnName("UpdatedDate").IsRequired();
        builder.Property(oc => oc.DeletedDate).HasColumnName("DeletedDate").IsRequired();
    ...
    //            foreach (OperationClaim featureOperationClaims in featureOperationClaimsToAdd)
    //            {
    //                yield return featureOperationClaims;
    //            }
    //        }
    //        #endregion
    //    }
